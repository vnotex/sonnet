...
#define SONNETUI_DECL_DEPRECATED_TEXT(text) __declspec(deprecated(text))
...
#  define SONNETUI_DISABLE_DEPRECATED_BEFORE_AND_AT 0x55200
#endif
...
#  else
#    define SONNETUI_DEPRECATED_WARNINGS_SINCE 0x55200
#  endif
#endif
